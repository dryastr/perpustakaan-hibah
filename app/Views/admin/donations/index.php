                        ...
                        <tbody>
                            <?php foreach ($donations as $index => $donation) : ?>
                                <tr>
                                    ...
                                    <td>Rp<?= number_format($donation['quantity'], 0, ',', '.') ?></td>
                                    ...
                                    <td class="text-nowrap">
                                        <div class="dropdown dropup">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <form action="<?= base_url('admin/donations/destroy/' . $donation['id']) ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus donasi ini?')">
...
<div class="modal fade" id="addDonationModal" tabindex="-1" aria-labelledby="addDonationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/donations/store') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
...
<script>
    function editDonation(donation) {
        document.getElementById('editDonationForm').action = `/admin/donations/update/${donation.id}`;
    ...
    function viewDonation(donation) {
        ...
        document.getElementById('view_status').innerHTML = `<span class="badge ${badgeClass}">${badgeText}</span>`;
